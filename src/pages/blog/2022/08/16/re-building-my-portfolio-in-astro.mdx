...
image: "/posts/blog/2022/08/16/re-building-my-portfolio-in-astro/re-building-my-portfolio-in-astro.png"
tags:
  [
    "HTML",
    "CSS",
...
import mainImage from "~posts/blog/2022/08/16/re-building-my-portfolio-in-astro/re-building-my-portfolio-in-astro.png";

export const components = { a: SmartLink, h1: TextTitle, img: LazyImage };

# Why Astro?

<Image src={mainImage} format="webp" alt="The new homepage for my portfolio" />
_A screenshot of my new portfolio_
