...
image: "/posts/projects/2022/07/04/layered-dithering/layered-dithering.png"
tags:
  [
    "JavaScript",
    "TypeScript",
...
import mainImage from "~posts/projects/2022/07/04/layered-dithering/layered-dithering.png";
...
<SmartLink class="block" href="https://layered-dithering.vercel.app/">
  <Image src={mainImage} alt="An image showcasing the web app" />
</SmartLink>
...
The website can be visited [here](https://layered-dithering.vercel.app/).

The source code can be viewed [here](https://github.com/royeden/layered-dithering).
