...
description: "A MIDI controller that uses Poses from your body to control notes. Built with MediaPipe's AI, Astro & SolidJS."
...
## A MIDI controller that uses Poses from your body to control notes

<SmartLink
  href="https://pose-ai-synth.vercel.app/"
...
>
  <OptimizedImage
    ...
    width={720}
    aspectRatio="16:9"
    src="/assets/posts/projects/2022/11/01/pose-ai-synth/pose-ai-synth.jpeg"
    alt="A Screenshot from the App"
  />
</SmartLink>
<div id="content">
### About
